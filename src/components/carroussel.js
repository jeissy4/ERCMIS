...
import img7 from '../assets/f6.jpg';
 ...
 export default function Carroussel(){
    return (
        <>
      {/* Slideshow Section */}
    <div id="financeCarousel" className="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <p>Efficient and transparent systems</p>
        ...
        <button className="carousel-control-prev" type="button" data-bs-target="#financeCarousel" data-bs-slide="prev">
          <span className="carousel-control-prev-icon" aria-hidden="true"></span>
          <span className="visually-hidden">Previous</span>
        </button>
        <button className="carousel-control-next" type="button" data-bs-target="#financeCarousel" data-bs-slide="next">
