...
export default function PSVLicenseFeePage() {
        ...
        <div className="col-lg-7 col-md-9 col-12">
          ...
          >
            <div className="card-body">
              ...
              >
                <strong>PSV License Fee</strong> allows you to pay for Public
                Service Vehicle's License within XX County. Choose your
