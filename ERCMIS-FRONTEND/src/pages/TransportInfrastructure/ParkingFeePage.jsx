        ...
        <div className="col-lg-7 col-md-9 col-12">
          ...
          >
            <div className="card-body">
              <p className="mb-4 text-info opacity-75" style={{ fontSize: "1.2rem" }}>
                <strong>Parking Fee</strong> allows you to pay for Parking
                within XX County. Choose your preferred payment method and fill
